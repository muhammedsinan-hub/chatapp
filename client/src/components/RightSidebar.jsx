...
const RightSidebar = ({ selectedUser, messages }) => {
  ...
  return (
    selectedUser && (
      <div
        className="hidden lg:flex bg-[#121212]/50 h-full text-white w-[300px] flex-col border-l border-white/5 animate-in slide-in-from-right duration-300 relative"
      >
          ...
          <div className="relative">
            <img
              ...
              className={`w-20 h-20 rounded-full object-cover border-2 border-violet-500/20 cursor-pointer transition-all duration-300 shadow-2xl ${
                isZoomed
                  ? "scale-125 z-50 ring-4 ring-black/30"
                  : "scale-100"
              }`}
            />
          </div>
